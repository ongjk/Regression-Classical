...
The loaded data contains `r ilo_data %>% count() %>% pull(n)` rows. 
...
```{r defining_a_theme, echo = TRUE, fig.height = 8, fig.width = 4.5, fig.align = "center"}
...
```{r fig.height = 8, fig.width = 4.5, fig.align = "center", echo = TRUE}
