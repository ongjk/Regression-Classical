...
ggplot(anthroMale1, aes(x = height)) + 
  ...
  stat_function(fun = dnorm, 
                ...
                color = "red")
ggplot(anthroMale1, aes(sample = height)) + 
  stat_qq() +
...
ggplot(anthrofeMale1, aes(sample = height)) + 
  stat_qq() +
  stat_qq_line(color = "red")
```

ANSWER: Its skewed, looking at the density it looks like its skewed right. Not normal
...
ANSWER: Not normal base on the qq plot. Looking at the density plot, its flat on top, more like a trapezoid. 
...
ANSWER: Looking at the men's density plot, it shows this relationship with a larger spike at around the 6 foot mark, which supports the source. it didn't completely break the normality of the men's normality but does show up. 
